...
possible_ttl = [1, 2, 4, 8, 16, 32, 64, 128, 255] #powers of 2 for 1 byte
...
class AssetType(Enum):
    ...
    Plc = 10             # Programmable Logic Controller
    Rtu = 11             # Remote Terminal Unit
    Mtu = 12             # Master Terminal Unit (SCADA Master)
    Hmi = 13             # Human-Machine Interface
    Controller = 14      # Other Controllers (generic)
    
    Sensor = 20          # Sensors (e.g., temp, flow, level)
    Actuator = 21        # Valves, relays, etc.
    Drive = 22           # VFDs, motor drives
